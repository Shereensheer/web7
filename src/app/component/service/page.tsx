...
function Service() {
  return (
    <div>
        <section className="text-black body-font bg-red-400">
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-col text-center w-full  mb-20">
      ...
      Over the span of 40 years, we have been monumental in launching and
      ...
      <div className="lg:w-1/3 sm:w-1/2 p-4">
        <div className="flex relative">
          <Image
            ...
            width={480}
          />
          <div className="px-8 py-9 relative z-10 w-full border-4 border-gray-200 bg-red-200 opacity-0 hover:opacity-100">
            <h2 className="tracking-widest text-sm title-font font-medium text-black mb-1">
              BLOW DRY
            </h2>
            <p className="leading-relaxed"><br/>
